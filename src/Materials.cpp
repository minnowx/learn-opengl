...
int Materials()
{
	...
	Shader CubeShader{ "resources/shader/2.2.shader.vs", "resources/shader/2.2.shader.fs" };
	Shader LightShader{ "resources/shader/2.2.shader.vs", "resources/shader/2.2.shader.light.fs" };
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		CubeShader.setVec3("material.ambient", glm::value_ptr(glm::vec3(1.0f, 0.5f, 0.31f)));
		CubeShader.setVec3("material.diffuse", glm::value_ptr(glm::vec3(1.0f, 0.5f, 0.31f)));
		CubeShader.setVec3("material.specular", glm::value_ptr(glm::vec3(0.5f, 0.5f, 0.5f)));
