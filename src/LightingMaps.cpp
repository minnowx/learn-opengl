...
int LightingMaps()
{
	...
	Shader CubeShader{ "resources/shader/2.4.shader.vs", "resources/shader/2.4.shader.fs" };
	Shader LightShader{ "resources/shader/2.4.shader.light.vs", "resources/shader/2.4.shader.light.fs" };
